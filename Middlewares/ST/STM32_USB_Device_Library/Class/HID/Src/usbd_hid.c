...
__ALIGN_BEGIN static uint8_t HID_CUSTOM_ReportDesc[HID_CUSTOM_REPORT_DESC_SIZE] __ALIGN_END
		...
		// 78 bytes
				...
				0x75, 0x01,        //   Report Size (1)
				0x95, 0x08,        //   Report Count (8)
				//www.usb.org/developers/hidpage/Hut1_12v2.pdf find the codes here;
				//if you are trying to extend functionality be sure to extend report size here and  in
				//Middlewares\ST\STM32_USB_Device_Library\Class\HID\Inc\usbd_hid.h too
				0x09, 0xB5,        //   Usage (Scan Next Track)
				0x09, 0xB6,        //   Usage (Scan Previous Track)
				0x09, 0xB7,        //   Usage (Print)
